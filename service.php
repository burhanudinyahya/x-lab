...
?>
<div class="jumbotron jumbotron-service jumbotron-inverse">
    <div class="container-responsive">
        <div class="container container-home">
            <div class="row">
                <div class="col-xs-10 col-xs-offset-1">
                <h1 class="jumbotron-title display-heading-1" itemprop="name">Service of conduct</h1>
                ...
                <p><a href="#" class="btn btn-jumbotron btn-theme-orange" rel="nofollow">See more Service</a></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
	<div class="row">
		...
		<h2 class="title-h2">Our Service, to love Your need</h2>
  		<p class="subtitle-p">After sales service and development are our priority, contribution and a best value</p>
			<div class="container marketing">
				<!-- START THE FEATURETTES -->
				<div class="row featurette">
					<div class="col-sm-5 col-md-5">
						<img class="featurette-image img-responsive center-block" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="100%">
					</div>
					<div class="col-sm-5 col-md-5">
